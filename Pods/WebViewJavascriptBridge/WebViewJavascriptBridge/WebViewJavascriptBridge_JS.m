...
;(function() {
	...
	function _doSend(message, responseCallback) {
        console.log(new Date() - window.JSTime,'________@点击按钮到JsB收到响应的时间');
        if (!window.JsBTime) {
            window.JsBTime = new Date();
        }
		if (responseCallback) {
	...
	function _fetchQueue() {
        ...
        if (window.JsBTime) {
            console.log(new Date() - window.JsBTime,'________@JsB收到响应到原生收到响应的时间');
            window.JsBTime = null;
            console.log(new Date() - window.JSTime,'________@点击按钮到原生收到响应的时间');
            window.JSTime = null;
        }
